...
class SpeechRecognitionWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, _quit_signal_message, parent=None):
        ...
        self.showMaximized()
        self.setWindowTitle("Speech Remote: configuration of speech recognition")
...
class FormWidget(QtWidgets.QWidget):
    ...
    def __controls(self):
        ...
        rootpath=QtCore.QDir.currentPath()+'/rec'
        ...
        self.CNN_Feed_Dir.setText(str(QtCore.QDir.currentPath()+'\rec\GENERAL\CSV'))
        ...
        self.CNN_Personalize_Dir.setText(str(QtCore.QDir.currentPath()+'\rec\PERSONAL\CSV'))
        ...
        CNN_Status = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/CNN_inactive.png')
        self.Label_CNN_Status.setPixmap(CNN_Status.scaled(65,60, transformMode=QtCore.Qt.SmoothTransformation))
        ...
        CNNTestStatus = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/CNN_test_inactive.png')
        self.Label_CNNTestStatus.setPixmap(CNNTestStatus.scaled(22,22, transformMode=QtCore.Qt.SmoothTransformation))
        ...
        VoiceRecordStatus = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/recording_inactive.png')
        self.Label_VoiceRecordStatus.setPixmap(VoiceRecordStatus.scaled(22,22, transformMode=QtCore.Qt.SmoothTransformation))
        ...
        WAV_to_CSV_Convert_Status = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/wav_to_csv_inactive.png')
        self.Label_WAV_to_CSV_Convert_Status.setPixmap(WAV_to_CSV_Convert_Status.scaled(65,60, transformMode=QtCore.Qt.SmoothTransformation))
        ...
        self.Filt_Spectr_Dir.setText(str(QtCore.QDir.currentPath()+'\rec\GENERAL\CSV'))
        ...
        Filt_Spectr_Status = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/filter_inactive.png')
        self.Label_Filt_Spectr_Status.setPixmap(Filt_Spectr_Status.scaled(42,40, transformMode=QtCore.Qt.SmoothTransformation))
    ...
    def populate_command_list(self):
        global audio_recording_output_format
        directory = QtCore.QDir.currentPath()+'/rec/PERSONAL'
        if audio_recording_output_format == 0:
    ...
    def check_silence_threshold(self):
        ...
        _signal_message=clib_speech.signal_message()
        ...
        if _mic != "":
             _indentify_silence_threshold = clib_speech.indentify_silence_threshold(_signal_message, _mic, _rate, _freq, _chunk, _format, _channels, _sampleduration)
    ...
    def recording_to_csv(self):
        ...
        self._signal_message=clib_speech.signal_message()
        ...
        _format = pyaudio.paInt16
        _channels = 1
        _directory = QtCore.QDir.currentPath()+'/rec/PERSONAL/CSV/'+str(self.CommandList.currentText())
        ...
        if _mic != "":
             _record_audio_csv = clib_speech.record_audio_csv(self._signal_message, _mic, _rate, _chunk, _commandchunk, _format, _channels, _directory, _numberoffiles, _silencethreshold, _stftsegmentsize, _overlappercent, _stftfreqres, _freqhighlim, _stft_lin_log_norm)
    ...
    def recording_to_wav(self):
        ...
        _format = pyaudio.paInt16
        _channels = 1
        _directory = QtCore.QDir.currentPath()+'/rec/PERSONAL/WAV/'+str(self.CommandList.currentText())
        _numberoffiles = command_repeats
        _silencethreshold = silence_treshold_slider
        
        if _mic != "":
             _record_audio_wav = clib_speech.record_audio_wav(self._signal_message, _mic, _rate, _chunk, _commandchunk, _format, _channels, _directory, _numberoffiles, _silencethreshold)
    ...
    def display_start_command_recording(self):
        VoiceRecordStatus = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/recording_active.png')
        self.Label_VoiceRecordStatus.setPixmap(VoiceRecordStatus.scaled(22,22, transformMode=QtCore.Qt.SmoothTransformation))
    ...
    def converting_wav_to_csv(self):
        ...
        _convert_wav_to_csv = clib_speech.convert_wav_to_csv(_signal_message, 
                                                        _source_directory, 
                                                        _target_directory,
    ...
    def display_WAV_to_CSV_active(self):
        WAV_to_CSV_Convert_Status = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/wav_to_csv_active.png')
        self.Label_WAV_to_CSV_Convert_Status.setPixmap(WAV_to_CSV_Convert_Status.scaled(65,60, transformMode=QtCore.Qt.SmoothTransformation))
    ...
    def filter_spectrogram_active(self):
        Filt_Spectr_Status = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/filter_active.png')
        self.Label_Filt_Spectr_Status.setPixmap(Filt_Spectr_Status.scaled(42,40, transformMode=QtCore.Qt.SmoothTransformation))
    ...
    def filter_spectrogram(self):
        ...
        _spectrogram_filter = clib_speech.spectrogram_filter(self._signal_message, _filt_spectr_directory)
    ...
    def display_CNN_active(self):
        CNN_Status = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/CNN_active.png')
        self.Label_CNN_Status.setPixmap(CNN_Status.scaled(65,60, transformMode=QtCore.Qt.SmoothTransformation))
    ...
    def built_CNN(self):
        ...
        SRT = clib_speech.speech_recognition_training(self._signal_message, 
                                       _CNN_feed_directory, 
                                       _CNN_personalize_directory,
    ...
    def CNN_check_silence_threshold(self):
        ...
        if _mic != "":
             _indentify_silence_threshold = clib_speech.indentify_silence_threshold(_signal_message, _mic, _rate, _freq, _chunk, _format, _channels, _sampleduration)
             _indentify_silence_threshold.start()
             CNNTestStatus = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/CNN_test_active.png')
             self.Label_CNNTestStatus.setPixmap(CNNTestStatus.scaled(22,22, transformMode=QtCore.Qt.SmoothTransformation))
    
    def CNN_File_manual_change(self):
        directory = str(QtCore.QDir.currentPath() + "/models")
    ...
    def CNN_test_ready(self):
        CNNTestStatus = QtGui.QPixmap(QtCore.QDir.currentPath()+'/res/img/CNN_test_ready.png')
        self.Label_CNNTestStatus.setPixmap(CNNTestStatus.scaled(22,22, transformMode=QtCore.Qt.SmoothTransformation))
        self.CNN_Test_CommandButton.setText("Test")
        self.CNN_Load_File_CommandButton.setText("Unload CNN")
        self.CNN_Test_CommandButton.setEnabled(True)
    ...
    def CNN_Load_network(self):
        try:
            ...
            self.SRL = clib_speech.speech_recognition_listening(self._signal_message,
                                                           _filename_hdf5,
                                                           _filename_csv)
